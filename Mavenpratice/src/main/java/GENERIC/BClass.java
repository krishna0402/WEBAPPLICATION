...
public class BClass
{
		...
		public void setExtent(){
			...
			extent.addSystemInfo("computer", "windows");
		...
		public void setup()
		{
			...
			System.setProperty("webdriver.chrome.driver", "E:\\STUDY\\Testing\\Selenium\\SELENIUM SOFTWARES\\Browser drivers\\chromedriver.exe");	
		...
		public void tearDown(ITestResult result) throws IOException{
			...
			if(result.getStatus()==ITestResult.FAILURE){
				...
				String screenshotPath = BClass.getScreenshot(driver, result.getName());
