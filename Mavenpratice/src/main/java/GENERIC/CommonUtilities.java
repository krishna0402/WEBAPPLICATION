...
public class CommonUtilities extends BClass
{
	public void waitForPageLoad()
	{
		BClass.driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	}
	public void windowMaximize()
	{
		BClass.driver.manage().window().maximize();
	}
	...
	{
		Actions act=new Actions(BClass.driver);
		act.moveToElement(wb).perform();
	}
	public void action2(WebElement wb1)
	{
		Actions act1=new Actions(BClass.driver);
		act1.moveToElement(wb1).perform();
	}
	public String getWindowIDs()
	{
	String WinID = null;
	Set<String> set = BClass.driver.getWindowHandles();
	...
	{
		BClass.driver.switchTo().window(WinID);
	}
